...
<body>
    ...
    <div class="main-content">
                ...
                <table class="table table-hover mb-0 bg-transparent">
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo "<tr>
                                    <td><img src='$img' style='width: 55px; height: 55px; object-fit: cover; border-radius: 50%; border: 1px blue solid; padding: 2px;'></td>
        ...
        <!-- page for admin --> <?php include "page_admin.php" ?>
